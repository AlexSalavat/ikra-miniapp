  ...
  return (
    ...
    >
      <div style={{ width: '100%', maxWidth: 440, padding: '0 14px' }}>
        <h1 style={{ color: '#fff', fontWeight: 800, fontSize: 22, letterSpacing: '.02em' }}>
          NeiroBiz
        </h1>
        <div style={{ color: '#b5e0fe', fontWeight: 700, fontSize: 14.5, marginTop: 4 }}>
        ...
        <div style={{ color: 'rgba(255,255,255,.7)', fontSize: 13, marginTop: 4 }}>
          ...
          <span style={{ color: '#23df81', fontWeight: 700 }}>
