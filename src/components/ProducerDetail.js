...
export default function ProducerDetail() {
  ...
  // Распаковываем даже если producer нет — чтобы хуки шли всегда в одном порядке
  const {
    name = "",
    logo,
    region = "",
          ...
          {gallery?.length > 0 && (
            <div className="mt-3 glass-card p-2">
              ...
              <div className="relative w-full rounded-xl overflow-hidden border border-white/10">
                {/* Если у тебя Tailwind < v3, замени className на "w-full h-64" */}
