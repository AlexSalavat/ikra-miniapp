      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: 13 }}>
            <label style={{ fontSize: 13.5, fontWeight: 600, color: '#6ee7b7' }}>Категория</label>
            <br />
            <select
              name="category"
              value={form.category}
          ...
          <div style={{ marginBottom: 13 }}>
            <label style={{ fontSize: 13.5, fontWeight: 600 }}>Название объявления *</label>
            <br />
            <input
              name="title"
              value={form.title}
          ...
          <div style={{ marginBottom: 13 }}>
            <label style={{ fontSize: 13.5, fontWeight: 600 }}>Компания / Продавец</label>
            <br />
            <input
              name="company"
              value={form.company}
          ...
          <div style={{ marginBottom: 13 }}>
            <label style={{ fontSize: 13.5, fontWeight: 600 }}>Регион / Город</label>
            <br />
            <input
              name="region"
              value={form.region}
          ...
          <div style={{ marginBottom: 13 }}>
            <label style={{ fontSize: 13.5, fontWeight: 600 }}>Цена *</label>
            <br />
            <input
              name="price"
              value={form.price}
          ...
          <div style={{ marginBottom: 13 }}>
            <label style={{ fontSize: 13.5, fontWeight: 600 }}>Контакты для связи *</label>
            <br />
            <input
              name="contact"
              value={form.contact}
          ...
          <div style={{ marginBottom: 13 }}>
            <label style={{ fontSize: 13.5, fontWeight: 600 }}>Описание</label>
            <br />
            <textarea
              name="description"
          ...
          <div style={{ marginBottom: 13, display: 'flex', gap: 9 }}>
            <div style={{ flex: 1 }}>
              <label style={{ fontSize: 13.5, fontWeight: 600 }}>Документы</label>
              <br />
              <input
                name="documents"
            ...
            <div style={{ flex: 1 }}>
              <label style={{ fontSize: 13.5, fontWeight: 600 }}>Склад</label>
              <br />
              <input
                name="warehouse"
          ...
          <div style={{ marginBottom: 13 }}>
            <label style={{ fontSize: 13.5, fontWeight: 600 }}>Оплата</label>
            <br />
            <input
              name="payment"
              value={form.payment}
          ...
          <div style={{ marginBottom: 17 }}>
            <label style={{ fontSize: 13.5, fontWeight: 600 }}>Фото (до 3 файлов)</label>
            <br />
            <input
              name="images"
              type="file"
          ...
          >
            {sending ? 'Отправка...' : 'Разместить объявление'}
          </button>
        </form>
      </div>
    </div>
