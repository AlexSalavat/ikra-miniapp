const producers = [
  {
    ...
    fullDescription:
      '«Корякморепродукт» — лидер рыбного промысла Камчатки. Современное оборудование, международные стандарты качества, экспорт икра, рыбы и морепродуктов по всей стране и за рубеж. ',
