      ...
      <div className="max-w-md mx-auto px-3 pt-3 grid grid-cols-2 gap-3">
        {items.map((it) => (
          <div
            ...
            onClick={() => { if (!it.locked) navigate(it.to); }}
            ...
            <div className="relative aspect-square rounded-lg overflow-hidden border border-white/10">
              ...
              {it.locked && (
                <>
                  ...
                  <div className="absolute top-1 right-1 w-5 h-5 rounded-full border border-[rgba(59,175,218,.7)] bg-white/10 grid place-items-center" title="Закрыто">
