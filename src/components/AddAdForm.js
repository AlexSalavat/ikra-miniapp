      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ width: "100%" }}>
          ...
          <div style={{ marginBottom: 13 }}>
            <label style={{ color: "#b9b9b9", fontSize: 13, fontWeight: 600 }}>Фото:</label><br />
            <input
              type="file"
              name="image"
              accept="image/*"
            ...
            {preview && (
              <div style={{ marginTop: 7 }}>
                <img src={preview} alt="preview" style={{ width: 108, borderRadius: 14, boxShadow: "0 2px 12px #181a1a44" }} />
              </div>
            )}
          </div>
