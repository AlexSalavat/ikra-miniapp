const producers = [
  {
    ...
    description:
      'Один из крупнейших рыбопромышленных холдингов Камчатки. Полный цикл добычи и переработки. Экспорт в Россию, Корею, Японию, Китай, ЕС. Сертификация Меркурий и Честный знак.',
    fullDescription:
      '«Корякморепродукт  лидер рыбного промысла Камчатки. Современное оборудование, международные стандарты качества, экспорт икры, рыбы и морепродуктов по всей стране и за рубеж.',
  ...
  },
  {
    ...
    fullDescription:
      'ООО Фирма Жупанова  производство и реализация высококачественной лососевой рыбы и икры. На рынке с 1996 года. Восточное побережье Камчатки.',
    site: '',
    isPlaceholder: false,
    address:
      'Камчатский край, г. Елизово, ул. Сопочная, 13. Офис: г. Петропавловск-Камчатский, ул. Ларина, 38, оф. 66',
    contacts: {
